...
var drawingApp = (function () {
    ...
    var canvas,
        ...
        init = function () {
            ...
            crayonImage.src = img_folder + "crayon-outline.png";

            markerImage.onload = resourceLoaded;
            markerImage.src = img_folder + "marker-outline.png";

            eraserImage.onload = resourceLoaded;
            eraserImage.src = img_folder + "eraser-outline.png";

            crayonBackgroundImage.onload = resourceLoaded;
            crayonBackgroundImage.src = img_folder + "crayon-background.png";

            markerBackgroundImage.onload = resourceLoaded;
            markerBackgroundImage.src = img_folder + "marker-background.png";

            eraserBackgroundImage.onload = resourceLoaded;
            eraserBackgroundImage.src = img_folder + "eraser-background.png";

            crayonTextureImage.onload = resourceLoaded;
            crayonTextureImage.src = img_folder + "crayon-texture.png";

            outlineImage.onload = resourceLoaded;
            outlineImage.src = img_folder + "watermelon-duck-outline.png";
        };
